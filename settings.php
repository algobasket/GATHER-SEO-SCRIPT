...
<html lang="en">
  <head>
    ...
    <style type="text/css">
    <style type="text/css">
         input[type="text"],textarea[name="locations"],textarea[name="template"],select[name="apiType"]{    
       ...
       <?php if($s == 'email-verify-api') : ?>
          ...
          <form method="POST"> 
            <table class="table table-bordered">
                ...
                <tr>    
                    <td><input type="text" class="form-control" name="redirectUrl" placeholder="REDIRECT"></td>   
                </tr>
                 <tr>    
                    <td><input type="submit" name="addNewApi" class="btn btn-outline-dark" value="Add" /></td>  
                </tr>
            </table>
          </form>  
